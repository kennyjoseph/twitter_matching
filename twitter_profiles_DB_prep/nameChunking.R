...
# Code to parse Twitter name and handle into words to index.
# Only need to call putThemTogether(), just below.
# Examples / test cases at the bottom show usage. 
# Sadly, all these >500 lines of code are in use (yes, it's a mess).
