...
matchResultsDirPref     = "/net/data/twitter-voters/match-results/targetsmart_preferred" 
matchResultsDirFull     = "/net/data/twitter-voters/match-results/targetsmart_fullStates" 
samplesDir            = "/net/data/twitter-voters/voter-data/preferred_chunks"
statesOfInterest = c("NH", "IA", "WI")
